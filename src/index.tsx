        ...
        <header class="header-gradient shadow-lg">
            <div class="container mx-auto px-4 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-display font-bold flex items-center gap-3 text-white">
                            <i class="fas fa-hospital"></i>
                            Senior Residences Europe
                        </h1>
                        <p class="text-white mt-2 font-sans opacity-95">Europas umfassendste Datenbank für Seniorenresidenzen + CRM + AI</p>
                    </div>
                    <button onclick="showIntelligentSearch()" class="bg-white text-emerald-600 hover:bg-emerald-50 hover:text-emerald-700 font-bold px-6 py-3 rounded-2xl transition-all transform hover:scale-105 flex items-center gap-2 shadow-xl">
